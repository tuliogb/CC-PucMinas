...
class Jogador {
    ...
    */
	...
	public void mostraPilha(Jogador i,int mostrar) {
		if (i != null) {
			mostraPilha(i.prox,--mostrar);
			i.Escrever(mostrar);
		}
	}
    ...
    public static void removerFim(){
        Jogador tmp = topo; mostraRemovido(tmp);
        topo = topo.prox;
        tmp.prox = null; tmp = null; tamanho--;
    }

    public static void mostraRemovido(Jogador jogador){
    ...
    public static void main(String[] args) {            // Compilar:    javac .\Jogador.java        Executar:    type .\pub.in | java Jogador > result.txt
        ...
        manipulaElementos();
        jogador.mostraPilha(topo,tamanho);
    }
