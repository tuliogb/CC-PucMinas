...
public class HashR {
    ...
    static HashR[] tabela = new HashR[25];
    ...
    public static void inserirJogador(Jogador jogador){
        int posicao = (jogador.altura % 25); comp++;
        
        if(tabela[posicao]==null) tabela[posicao] = new HashR(jogador);
        else{
            int reHash = (jogador.altura+1) % 25;
            if(tabela[reHash]==null) tabela[reHash] = new HashR(jogador);
        }
    }
	...
	public static void ArqLog(long tempo) {
		String nomeArq = "802512_hashRehash.txt";
		String mtr = "802512";
