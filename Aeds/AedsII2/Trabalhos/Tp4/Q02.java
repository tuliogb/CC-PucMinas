...
public class CtrlPersonagem{
    ...
    static No inserir(No i, int elemento){
    ...
    static No2 inserirNo2(No2 i, Personagem elemento){
        if(i==null) i = new No2(elemento);
        else if(elemento.getName().compareTo(i.elemento.getName())<0) i.esq = inserirNo2(i.esq, elemento);
        else if(elemento.getName().compareTo(i.elemento.getName())>0) i.dir = inserirNo2(i.dir, elemento);
        return i;
    }
