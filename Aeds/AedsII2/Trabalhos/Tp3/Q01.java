...
/**
 * Questao 1 - Trabalho Pratico 3 - Aeds II - CC_PUCMINAS
...
public class CtrlPersonagem{
    ...
    static void removerInicio(){
        System.out.println("(R) " + Lista[0].getName());
    ...
    static void remover(String p){
        int posicao = Integer.parseInt(p);
        System.out.println("(R) " + Lista[posicao].getName());
    ...
    static void removerFim(){
        System.out.println("(R) " + Lista[entradas-1].getName());
        entradas--;
    }
